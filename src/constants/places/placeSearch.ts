...
> = {
  ko: {
    ...
    categoryLabels: {
      ...
      [PLACE_CONTENT_TYPE.culture]: '문화시설',
      [PLACE_CONTENT_TYPE.festival]: '축제·공연·행사',
      [PLACE_CONTENT_TYPE.course]: '여행코스',
      [PLACE_CONTENT_TYPE.leisure]: '레포츠',
      [PLACE_CONTENT_TYPE.accommodation]: '숙박',
      [PLACE_CONTENT_TYPE.shopping]: '쇼핑',
  ...
  en: {
    ...
    categoryLabels: {
      ...
      [PLACE_CONTENT_TYPE.culture]: 'Culture',
      [PLACE_CONTENT_TYPE.festival]: 'Festivals & Events',
      [PLACE_CONTENT_TYPE.course]: 'Travel courses',
      [PLACE_CONTENT_TYPE.leisure]: 'Leisure sports',
      [PLACE_CONTENT_TYPE.accommodation]: 'Stays',
      [PLACE_CONTENT_TYPE.shopping]: 'Shopping',
  ...
  ja: {
    ...
    categoryLabels: {
      ...
      [PLACE_CONTENT_TYPE.culture]: '文化施設',
      [PLACE_CONTENT_TYPE.festival]: '祭り・公演・行事',
      [PLACE_CONTENT_TYPE.course]: '旅行コース',
      [PLACE_CONTENT_TYPE.leisure]: 'レジャー',
      [PLACE_CONTENT_TYPE.accommodation]: '宿泊',
      [PLACE_CONTENT_TYPE.shopping]: 'ショッピング',
  ...
  zh: {
    ...
    categoryLabels: {
      ...
      [PLACE_CONTENT_TYPE.culture]: '文化设施',
      [PLACE_CONTENT_TYPE.festival]: '节庆演出活动',
      [PLACE_CONTENT_TYPE.course]: '旅行路线',
      [PLACE_CONTENT_TYPE.leisure]: '休闲体育',
      [PLACE_CONTENT_TYPE.accommodation]: '住宿',
      [PLACE_CONTENT_TYPE.shopping]: '购物',
